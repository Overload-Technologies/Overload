...
OvGame::Debug::FrameInfo::FrameInfo(OvWindowing::Window& p_window) :
	m_window(p_window),
	m_batchText(CreateWidget<OvUI::Widgets::Texts::TextColored>("", OVUI_STYLE_REF(Warning))),
	m_instanceText(CreateWidget<OvUI::Widgets::Texts::TextColored>("", OVUI_STYLE_REF(Warning))),
	m_polyText(CreateWidget<OvUI::Widgets::Texts::TextColored>("", OVUI_STYLE_REF(Warning))),
	m_vertexText(CreateWidget<OvUI::Widgets::Texts::TextColored>("", OVUI_STYLE_REF(Warning)))
{
